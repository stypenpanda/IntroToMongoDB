#NYTimes API:      7c8bc793cac43970605da440e20359f9:3:72353922
#NYTimes API - Most Popular: 598865538b4b2498ffe4ecda0b3cecfb:16:72353922
#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""
...
API_KEY = { "popular": "598865538b4b2498ffe4ecda0b3cecfb:16:72353922",
            "article": "7c8bc793cac43970605da440e20359f9:3:72353922"}
...
def article_overview(kind, period):
    ...
    for e in data:
        lstTitles.append({e['section']:e['title']})
    # Build list of Urls:
    for e in data:
        for f in e['media']:
            for g in f['media-metadata']:
                if g['format'] == 'Standard Thumbnail':
                    lstUrls.append(g['url'])

    return (lstTitles, lstUrls)
